--Census Everybody Everything Official Fall Snapshot --37708 rows 10/21/2020 (legacy 37945)
with total_fte as
(select emplid, sum(fte_cnt) as tot_fte from dw_common.f_emp_hc_fte_snap where curr_emplid is not null and pay_prd_snap_dt='10/21/2020' group by emplid),
total_ibs as
(select d.emplid,
...
from dw_common.F_EMP_CMPNT_PAY_snap f, dw_common.D_UM_EMP_snap d
...
and d.pay_prd_snap_dt='10/21/2020'
and f.pay_prd_snap_dt='10/21/2020'
group by d.emplid),
paid as
...
and pay_prd_snap_dt='10/21/2020')
SELECT distinct
a.EMPLID,
a.DSPL_LST_NM,
a.DSPL_FST_NM,
...
b.UNION_DESC,
b.REG_TEMP_CD
from dw_common.d_hr_cmm_pers_snap a, dw_common.d_um_emp_snap b, dw_common.d_um_emp_snap c, dw_common.d_hr_cmm_pers_snap d, R_JOB_FAM_GRP f, paid p, total_fte fte, total_ibs i
...
--and most_recent_payroll='10/21/2020' --faculty & staff headcount is 26,584 on 10/28/2020
and a.pay_prd_snap_dt='10/21/2020'
and b.pay_prd_snap_dt='10/21/2020'
and c.pay_prd_snap_dt(+)='10/21/2020'
and d.pay_prd_snap_dt(+)='10/21/2020'
