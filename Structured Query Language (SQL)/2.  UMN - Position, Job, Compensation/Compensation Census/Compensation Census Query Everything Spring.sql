--Census Everybody Everything Spring Snapshot --40529 rows 4/8/2020 (legacy 40716)
with total_fte as
(select emplid, sum(fte_cnt) as tot_fte from dw_common.f_emp_hc_fte_snap where curr_emplid is not null and pay_prd_snap_dt='4/8/2020' group by emplid),
total_ibs as
(select d.emplid,
...
and d.pay_prd_snap_dt='4/8/2020'
and f.pay_prd_snap_dt='4/8/2020'
group by d.emplid),
paid as
...
and a.pay_prd_snap_dt='4/8/2020'
and b.pay_prd_snap_dt='4/8/2020'
and c.pay_prd_snap_dt(+)='4/8/2020'
and d.pay_prd_snap_dt(+)='4/8/2020'
